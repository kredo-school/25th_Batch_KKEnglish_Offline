    ...
    public function run(): void
    {
        $teachers = [
            ...
            [
                ...
                'gender' => 'Male',
                'nationality' => 'Philippines',
                'profile_image' => 'https://files.slack.com/files-pri/T05PBHKDH52-F0C4G3Z779A/img_4426.jpeg',
            ...
            [
                ...
                'biography' => 'IT Team Lead.',
                'point_consumed' => 150,
                'career' => 'IT Manager and Instructor at Kredo',
                'graduation_school' => 'Not publicly specified',
                'certification' => 'Not publicly specified',
                'about_me' => 'I like Sushi.',
                'specialty' => 'All IT and English subjects',
                'rating_average' => 5.0,
            ],
        ];
